...
PATH_TO_CWS=~/Catkin_ws/vinseval_cws
...
#set_larvio_params () {
#	sed -i -e 's/\bnoise_acc:.*/noise_acc: '${1}'/' ${PATH_TO_CWS}/src/LARVIO/config/vinseval.yaml
#	sed -i -e 's/\bnoise_gyro:.*/noise_gyro: '${2}'/' ${PATH_TO_CWS}/src/LARVIO/config/vinseval.yaml
#	sed -i -e 's/\bnoise_acc_bias:.*/noise_acc_bias: '${3}'/' ${PATH_TO_CWS}/src/LARVIO/config/vinseval.yaml
#	sed -i -e 's/\bnoise_gyro_bias:.*/noise_gyro_bias: '${4}'/' ${PATH_TO_CWS}/src/LARVIO/config/vinseval.yaml
#	sed -i -e 's/\btd:.*/td: '${5}'/' ${PATH_TO_CWS}/src/LARVIO/config/vinseval.yaml
#}
...
#set_rovio_params () {
#	sed -i -e 's/.*X-covariance parameter of velocity prediction.*/        vel_0 '${1}'; X-covariance parameter of velocity prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Y-covariance parameter of velocity prediction.*/        vel_1 '${1}'; Y-covariance parameter of velocity prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Z-covariance parameter of velocity prediction.*/        vel_2 '${1}'; Z-covariance parameter of velocity prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*X-covariance parameter of accelerometer bias prediction.*/        acb_0 '${2}'; X-covariance parameter of accelerometer bias prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Y-covariance parameter of accelerometer bias prediction.*/        acb_1 '${2}'; Y-covariance parameter of accelerometer bias prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Z-covariance parameter of accelerometer bias prediction.*/        acb_2 '${2}'; Z-covariance parameter of accelerometer bias prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*X-covariance parameter of gyroscope bias prediction.*/        gyb_0 '${3}'; X-covariance parameter of gyroscope bias prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Y-covariance parameter of gyroscope bias prediction.*/        gyb_1 '${3}'; Y-covariance parameter of gyroscope bias prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Z-covariance parameter of gyroscope bias prediction.*/        gyb_2 '${3}'; Z-covariance parameter of gyroscope bias prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*X-covariance parameter of attitude prediction.*/        att_0 '${4}'; X-covariance parameter of attitude prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Y-covariance parameter of attitude prediction.*/        att_1 '${4}'; Y-covariance parameter of attitude prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#	sed -i -e 's/.*Z-covariance parameter of attitude prediction.*/        att_2 '${4}'; Z-covariance parameter of attitude prediction/' ${PATH_TO_CWS}/src/rovio/cfg/rovio.info
#}

# set_okvis_params () {
#	 sed -i -e 's/.*sigma_g_c.*/    sigma_g_c: '${1}'/' ${PATH_TO_CWS}/src/okvis_ros/config/vinseval.yaml
#	 sed -i -e 's/.*sigma_a_c.*/    sigma_a_c: '${2}'/' ${PATH_TO_CWS}/src/okvis_ros/config/vinseval.yaml
#	 sed -i -e 's/.*sigma_gw_c.*/    sigma_gw_c: '${3}'/' ${PATH_TO_CWS}/src/okvis_ros/config/vinseval.yaml
#	 sed -i -e 's/.*sigma_aw_c.*/    sigma_aw_c: '${4}'/' ${PATH_TO_CWS}/src/okvis_ros/config/vinseval.yaml
#	 sed -i -e 's/\bimageDelay:.*/imageDelay: '${5}'.0/' ${PATH_TO_CWS}/src/okvis_ros/config/vinseval.yaml
# }
